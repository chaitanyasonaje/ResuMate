...
export async function generateMetadata({
  ...
  if (resume?.firstName === undefined && resume?.lastName === undefined) {
    return {
      title: "ResuMate - Professional AI Resume Builder",
      description:
  ...
  return {
    ...
    ${resume?.lastName}${resume?.lastName && " "}- ResuMate`,
    description: `${resume?.firstName} ${resume?.lastName}'s Resume. Powered by ResuMate.`,
  };
}
